...
const TestimonialCard = ({
  ...
  return (
    <div className="bg-surface-2 rounded-lg shadow-md p-5 h-full flex flex-col gap-3">
...
export default function Testimonials() {
  ...
  return (
    <section className="relative mb-8">
      ...
      <Container vatiant="surface" className="flex flex-col lg:flex-row gap-10">
        <div className="lg:w-1/3">
          <SectionDesc title1="Trusted by Homeowners" title2="Across Ontario" />
        </div>
